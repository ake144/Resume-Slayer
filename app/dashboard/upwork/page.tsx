      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-5">
          <div className="bg-[#0a0a0c] border border-gray-800 rounded-2xl p-5 shadow-lg">
            ...
            <textarea
              className="w-full bg-[#111] border border-gray-800 rounded-xl p-4 text-sm text-gray-300 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500/50 transition-all min-h-[220px] resize-y placeholder:text-gray-600"
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold py-4 rounded-xl shadow-lg shadow-emerald-600/20 transition-all flex items-center justify-center gap-2"
          >
            {isGenerating ? (
              <>
        ...
        <div className="bg-[#0a0a0c] border border-gray-800 rounded-2xl flex flex-col shadow-lg overflow-hidden lg:h-[730px]">
          <div className="p-5 border-b border-gray-800 bg-[#111] flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-bold text-white">Your Proposal</h3>
            </div>
            {generatedProposal && (
              <button
                onClick={handleCopy}
          ...
          <div className="flex-1 p-6 overflow-y-auto">
            {!generatedProposal ? (
              <div className="h-full flex flex-col items-center justify-center text-gray-500 space-y-4">
                ...
                <p className="text-sm">Your generated Upwork proposal will appear here.</p>
              </div>
            ) : (
