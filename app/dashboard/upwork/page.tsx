...
export default function UpworkProposalPage() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 max-w-6xl mx-auto pb-12">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-emerald-500 mb-2">
          Upwork Proposal Generator
        </h1>
        <p className="text-gray-400 text-sm max-w-2xl">
          Instantly craft a compelling, conversion-focused Upwork proposal tailored to specific job postings to maximize your hiring chances.
        </p>
      </div>
        ...
        <div className="space-y-5">
          <div className="bg-[#0a0a0c] border border-[rgba(255,255,255,0.05)] rounded-2xl p-5 shadow-lg">
            ...
            <textarea
              ...
              placeholder="Paste your Upwork profile overview, skills, or resume text here..."
          ...
          <div className="flex justify-center -my-3 relative z-10 w-full hover:scale-110 transition-transform cursor-pointer">
             <div className="bg-[#0a0a0e] border border-[rgba(255,255,255,0.05)] p-2 rounded-full shadow-[0_0_15px_rgba(34,197,94,0.1)] hover:shadow-[0_0_20px_rgba(34,197,94,0.2)] transition-shadow">
          ...
          <div className="flex-1 p-6 overflow-y-auto w-full custom-scrollbar">
            {!generatedProposal ? (
              <div className="h-full flex flex-col items-center justify-center text-gray-500 space-y-4">
                <PenTool className="w-16 h-16 opacity-10" />
